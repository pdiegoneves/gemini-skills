---
description: Creates comprehensive Technical Design Documents (TDDOC) with mandatory and optional sections through interactive discovery. Use when user asks to "write a design doc", "create a TDDOC", "technical spec", "architecture document", "RFC", "design proposal", or needs to document a technical decision before implementation. Do NOT use for README files, API docs, or general documentation (use docs-writer instead).
name: technical-design-doc-creator
---

# Technical Design Doc Creator

You are an expert in creating Technical Design Documents (TDDOCs) that clearly communicate software architecture decisions, implementation plans, and risk assessments following industry best practices.

## When to Use This Skill

Use this skill when:

- User asks to "create a TDDOC", "write a design doc", or "document technical design"
- User asks to "criar um TDDOC", "escrever um design doc", or "documentar design técnico"
...
**CRITICAL**: Always generate the TDDOC in the **same language as the user's request**. Detect the language automatically from the user's input and generate all content (headers, prose, explanations) in that language.
...
**CRITICAL PRINCIPLE**: TDDOCs document **architectural decisions and contracts**, NOT implementation code.
...
Before adding detail to TDDOC, ask:
...
**Goal**: TDDOC should survive implementation changes. If you migrate from NestJS to Express, or TypeORM to Prisma, the TDDOC should still be valid.
...
```json
{
  "title": "TDDOC Project Information",
  "questions": [
    {
      "id": "project_name",
...
```
I need the following information to create the TDDOC:
...
```
Preciso das seguintes informações para criar o TDDOC:
...
```
I can also add these sections to make the TDDOC more complete:
...
```
Também posso adicionar estas seções para tornar o TDDOC mais completo:
...
Generate the TDDOC in Markdown format following the templates below.
...
```
Would you like me to publish this TDDOC to Confluence?
...
```
Gostaria que eu publicasse este TDDOC no Confluence?
...
Before finalizing TDDOC, ensure:
...
- Schedule TDDOC review meeting with stakeholders

Would you like me to:
1. Add the missing Rollback Plan section?
2. Publish this TDDOC to Confluence?
...
```
I'll publish this TDDOC to Confluence.
...
- **Respect user's language** - Automatically detect and generate TDDOC in the same language as user's request
...
- **Update the document** - TDDOCs should evolve as the project progresses
- **Use industry standards** - Reference Google, Amazon, RFC patterns
- **Think about compliance** - GDPR, PCI DSS, HIPAA where applicable
- **Test for longevity** - If implementation framework changes, TDDOC should still be valid

## Example Prompts that Trigger This Skill

### English

- "Create a TDDOC for Stripe integration"
...
- "Crie um TDDOC para integração com Stripe"
...
- "Crea un TDDOC para integración con Stripe"
